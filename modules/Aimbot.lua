...
Aimbot.Config = nil  -- будет присвоено из main
...
function Aimbot.Init(config)
    ...
    -- Функция для обновления статуса из UI
    function Aimbot.UpdateStatus()
        StatusLabel.Text = "Aimbot: " .. (Aimbot.Enabled and "ON" or "OFF") .. " | Часть: " .. Aimbot.Config.targetPart .. " | FullT: " .. (Aimbot.Config.fullTarget and "ON" or "OFF")
        StatusLabel.TextColor3 = Aimbot.Enabled and Color3.fromRGB(0, 255, 0) or Color3.fromRGB(255, 255, 255)
        StatusLabel.BackgroundColor3 = Aimbot.Enabled and Color3.fromRGB(0, 100, 0) or Color3.fromRGB(0, 0, 0)
    end
end
